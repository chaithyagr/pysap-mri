...
class Grad2D_pMRI_synthesis(GradBasic, PowerMethod):
    ...
    """
    def __init__(self, data, fourier_op, linear_op, max_iter, gradient_spec_rad=None):
        """ Initilize the 'GradSynthesis2' class.
        """
...
class Gradient_pMRI_calibrationless(Grad2D_pMRI_analysis, Grad2D_pMRI_synthesis):
    ...
    * (1/2) * (||Ft L* alpha - yl||^2_2,l)
    ...
    def __init__(self, data, fourier_op, linear_op=None, check_lips=False,
                 gradient_spec_rad=None, max_iter=10):
        ...
        if linear_op is None:
            Grad2D_pMRI_analysis.__init__(self, data, fourier_op, max_iter=max_iter,
            ...
            Grad2D_pMRI_synthesis.__init__(self, data, fourier_op, linear_op, max_iter=max_iter,
                                           gradient_spec_rad=gradient_spec_rad)
            if check_lips or gradient_spec_rad is not None:
